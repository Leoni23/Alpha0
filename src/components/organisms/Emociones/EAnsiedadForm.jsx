...
export const EAnsiedadForm = ({ ansiedad }) => {
        ...
        try {
            ...
            if (ansiedad?.id) {
                const response = await axios.post(
                    `https://alphaofinal.herokuapp.com/api/alpha/ansiedad/${1}/update`,
                    data,
            ...
            <div className="panel-body">
                <form onSubmit={handleSubmit}>
                    ...
                    <p className="text-center">
                        <button value={ansiedad?.id ? 'Actualizar' : 'Guardar'} type="submit" className="btn btn-info btn-raised btn-sm" >

...
export const SoledadForm = ({ soledad }) => {
    ...
    const [genero, setGenero] = useState(soledad?.genero || "");
    const [duracion, setDuracion] = useState(soledad?.duracion || "");
            ...
            <div className="panel-body">
                <form onSubmit={handleSubmit}>
                    ...
                    <p className="text-center">
                        <button value={soledad?.id ? 'Actualizar' : 'Guardar'} type="submit" className="btn text-light btn-raised btn-sm"
